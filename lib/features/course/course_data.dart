/// Dữ liệu khóa học hardcode ở dạng JSON-like map.
///
/// File này không trả về domain entity trực tiếp.
/// Nó giả lập dữ liệu thô từ API/local database để data source parse sang `CourseModel`.
///
/// Vấn đề cần quan sát:
...
const List<Map<String, Object?>> mockCourseJsonList = [
  {
    'id': 'crs_01',
